...
export default async function (hre: HardhatRuntimeEnvironment) {
  ...
  const gmxMigrator = await deployContract(hre, "GmxMigrator", [2])
  const gmtGmxIou = await deployContract(hre, "GmxIou", [gmxMigrator.address, "GMT GMX (IOU)", "GMT:GMX"])
  const xgmtGmxIou = await deployContract(hre, "GmxIou", [gmxMigrator.address, "xGMT GMX (IOU)", "xGMT:GMX"])
  const gmtUsdgGmxIou = await deployContract(hre, "GmxIou", [gmxMigrator.address, "GMT-USDG GMX (IOU)", "GMT-USDG:GMX"])
  const xgmtUsdgGmxIou = await deployContract(hre, "GmxIou", [gmxMigrator.address, "xGMT-USDG GMX (IOU)", "xGMT-USDG:GMX"])
