...
import { deployContract, sendTxn, getFrameSigner } from "../shared/helper";
...
export default async function (hre: HardhatRuntimeEnvironment) {
  ...
  if (positionManagerAddress) {
    ...
    positionManager = { address: "0x489ee077994B6658eAfA855C308275EAd8097C4A" }
  } else {
    ...
    positionManager = await deployContract(hre, "PositionManager", positionManagerArgs)
  }
...
async function getArbValues(signer) {
  ...
  const timelock = { address: "0x85E76cbf4893c1fbcB34dCF1239A91CE2A4CF5a7" }
  const router = { address: "0x85E76cbf4893c1fbcB34dCF1239A91CE2A4CF5a7" }
  const shortsTracker = { address: "0xf58eEc83Ba28ddd79390B9e90C4d3EbfF1d434da" }
  const weth = { address: "0x85E76cbf4893c1fbcB34dCF1239A91CE2A4CF5a7" }
  const orderBook = { address: "0x09f77E8A13De9a35a7231028187e9fD5DB8a2ACB" }
  const referralStorage = { address: "0xe6fab3f0c7199b0d34d7fbe83394fc0e0d06e99d" }
...
async function getAvaxValues(signer) {
  ...
  const timelock = { address: "0x489ee077994B6658eAfA855C308275EAd8097C4A" }
  const router = { address: "0x489ee077994B6658eAfA855C308275EAd8097C4A" }
  const shortsTracker = { address: "0x9234252975484D75Fd05f3e4f7BdbEc61956D73a" }
  const weth = { address: "0x489ee077994B6658eAfA855C308275EAd8097C4A" }
  const orderBook = { address: "0x4296e307f108B2f583FF2F7B7270ee7831574Ae5" }
  const referralStorage = { address: "0x827ed045002ecdabeb6e2b0d1604cf5fc3d322f8" }
